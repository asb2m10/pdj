...
static int initIDCaching(JNIEnv *env) {
	...
	pdjCaching.MIDMaxObject_processInlet =
		(*env)->GetMethodID(env, pdjCaching.cls_MaxObject, "_processInlet", "(Ljava/lang/String;[Lcom/cycling74/max/Atom;)V");
	JASSERT(pdjCaching.MIDMaxObject_processInlet);
